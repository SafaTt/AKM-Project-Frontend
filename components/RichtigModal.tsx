    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.container}>
          {/* Animation Lottie */}
          <LottieView
            source={require("@/assets/lottie/correct.json")} // mets ton fichier lottie ici
            autoPlay
            loop={false}
            style={{ width: 150, height: 150, marginBottom: 20 }}
          />

          <Text style={styles.title}>Richtig Antwort!</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: "bold", color: "green", marginBottom: 10 },
